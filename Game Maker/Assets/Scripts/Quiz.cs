...
public class Quiz : MonoBehaviour
{
    ...
    void DisplayAnswer(int intIndex) 
    {
        ...
        if(intIndex == currentQuestion.IntGetCorrectAnswerIndex())
        {
        ...
        else
        {
            ...
            string strCorrectAnswer = currentQuestion.StrGetAnswer(intCorrectAnswerIndex);
